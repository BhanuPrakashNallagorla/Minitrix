...
const UseCases = () => {
  ...
  const useCases: UseCase[] = [
    ...
    },
    {
      ...
      summary: 'AI-powered molecular analysis and compound optimization.',
      industry: 'healthcare',
      metrics: ['3x Faster Discovery', '65% Cost Reduction'],
      icon: <Search className="h-8 w-8" />
    },
    {
      id: '8',
      title: 'Patient Communication Hub',
      summary: 'Automated patient engagement and appointment scheduling.',
      industry: 'healthcare',
      metrics: ['89% Patient Satisfaction', '50% Admin Reduction'],
    ...
    },
    {
      ...
      summary: 'AI-powered case law research and precedent analysis.',
      industry: 'legal',
      metrics: ['90% Research Efficiency', '60% Cost Savings'],
      icon: <Search className="h-8 w-8" />
    },
    {
      id: '11',
      title: 'Document Discovery',
      summary: 'Intelligent document classification and privilege review.',
      industry: 'legal',
      metrics: ['99% Classification Accuracy', '80% Time Savings'],
      icon: <Scale className="h-8 w-8" />
    },
    {
      id: '12',
      title: 'Compliance Monitoring',
      summary: 'Automated regulatory compliance tracking and reporting.',
      industry: 'legal',
      metrics: ['100% Compliance Rate', '65% Effort Reduction'],
      icon: <Shield className="h-8 w-8" />
    },
    ...
    // E-Commerce
    {
      ...
      summary: 'AI-driven product recommendations based on customer behavior and preferences.',
      industry: 'ecommerce',
      metrics: ['35% Conversion Increase', '250% ROI'],
      icon: <Target className="h-8 w-8" />
    },
    {
      id: '14',
      title: 'Dynamic Pricing Optimization',
      summary: 'Real-time price optimization based on market conditions and demand.',
      industry: 'ecommerce',
      metrics: ['18% Revenue Increase', '92% Price Accuracy'],
      icon: <TrendingUp className="h-8 w-8" />
    },
    {
      id: '15',
      title: 'Customer Support Automation',
      summary: 'Intelligent chatbots and automated customer service solutions.',
      industry: 'ecommerce',
      metrics: ['24/7 Availability', '70% Resolution Rate'],
      icon: <Bot className="h-8 w-8" />
    },
    {
      id: '16',
      title: 'Inventory Management',
      summary: 'AI-powered demand forecasting and inventory optimization.',
      industry: 'ecommerce',
      metrics: ['25% Inventory Reduction', '95% Forecast Accuracy'],
    ...
    // Manufacturing
    {
      ...
      summary: 'AI-powered equipment monitoring and failure prediction.',
      industry: 'manufacturing',
      metrics: ['85% Downtime Reduction', '300% ROI'],
      icon: <Factory className="h-8 w-8" />
    },
    {
      id: '18',
      title: 'Quality Control Automation',
      summary: 'Automated defect detection and quality assurance processes.',
      industry: 'manufacturing',
      metrics: ['99.5% Detection Rate', '60% Cost Reduction'],
      icon: <Shield className="h-8 w-8" />
    },
    {
      id: '19',
      title: 'Supply Chain Optimization',
      summary: 'AI-driven supply chain planning and logistics optimization.',
      industry: 'manufacturing',
      metrics: ['20% Cost Reduction', '95% On-Time Delivery'],
      icon: <TrendingUp className="h-8 w-8" />
    },
    {
      id: '20',
      title: 'Production Planning Intelligence',
      summary: 'Automated production scheduling and resource allocation.',
      industry: 'manufacturing',
      metrics: ['30% Efficiency Gain', '40% Waste Reduction'],
      icon: <BarChart3 className="h-8 w-8" />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
            ...
            <div className="col-span-8 bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8">
              <div className="h-full flex flex-col">
                ...
                <div className="flex-grow">
                  ...
                  {/* CTA Button */}
                  <button className="w-full py-4 bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 flex items-center justify-center group">
                    View Case Study
            ...
            <div key={useCase.id} className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl overflow-hidden">
              ...
              {expandedMobile === useCase.id && (
                <div className="p-6 pt-0 border-t border-gray-700">
                  ...
                  {/* CTA Button */}
                  <button className="w-full py-3 bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 text-white font-medium rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/25 flex items-center justify-center group">
                    View Case Study
      ...
      {/* Final CTA Section */}
      <section className="py-20 px-6 bg-gradient-to-r from-gray-900/80 to-gray-800/60 backdrop-blur-sm border-t border-gray-800">
